...
// Master a single file (2-Pass Calibrated WAV + High Quality MP3 with Auto-Genre & Studio Metadata)
async function masterSingleFile(inputFile, outputFolder, options = {}) {
  ...
  // Create automatic subfolders wav/ and mp3/
  ...
  // --- PASS 1: Acoustic Analysis & Loudness Measurement ---
  ...
  // --- PASS 2: Linear Precision Rendering with Profile, Auto-Fade & Studio Metadata ---
  ...
  const metaArgs = [
    '-map_metadata', '-1', // Completely strip all AI watermarks
  ...
  const result = {
    ...
    optimizations: {
      ...
      stereoWidth: `Stereo widening factor: ${pass2.settings.stereoWidth}x (better spatial depth)`,
