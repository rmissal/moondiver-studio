...
async function mixStems(targetFolder, options = {}) {
  ...
  if (drumsPath) {
    ...
    if (d.punchGain && d.punchGain !== 0)
      dFilters.push(`equalizer=f=${d.punchFreq || 3500}:t=q:w=1.0:g=${d.punchGain}`);
  ...
  if (otherPath) {
    ...
    if (o.guitarBiteGain && o.guitarBiteGain !== 0)
      oFilters.push(`equalizer=f=${o.guitarBiteFreq || 2200}:t=q:w=1.0:g=${o.guitarBiteGain}`);
    if (o.width && o.width !== 1.0 && o.width <= 1.1) oFilters.push(`stereotools=slev=${o.width}:mlev=1.0`);
