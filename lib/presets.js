...
const PRESETS = {
  auto: {
    ...
    airTrebleFreq: 10500,
    stemMix: {
      vocals: { volume: 1.20, highpass: 100, trebleGain: 2.5, trebleFreq: 8000 },
      bass: { volume: 0.90, mono: true, lowpass: 400, boostFreq: 80, boostGain: 1.0 },
      drums: { volume: 1.00, punchFreq: 3500, punchGain: 1.0 },
      other: { volume: 0.85, width: 1.20, deMudFreq: 320, deMudGain: -2.0 }
    }
  },
  new_age_ambient: {
    ...
    airTrebleFreq: 10500,
    stemMix: {
      vocals: { volume: 1.15, highpass: 110, trebleGain: 3.0, trebleFreq: 8500 },
      bass: { volume: 0.85, mono: true, lowpass: 350, boostFreq: 75, boostGain: 1.2 },
      drums: { volume: 0.75, punchFreq: 4000, punchGain: 0.5 }, // softer drums
      other: { volume: 1.05, width: 1.35, deMudFreq: 320, deMudGain: -2.5 } // wide lush pads
    }
  },
  cinematic_orchestral: {
    ...
    airTrebleFreq: 11000,
    stemMix: {
      vocals: { volume: 1.10, highpass: 90, trebleGain: 2.0, trebleFreq: 9000 },
      bass: { volume: 1.10, mono: true, lowpass: 300, boostFreq: 65, boostGain: 1.8 }, // massive sub/timpani
      drums: { volume: 1.15, punchFreq: 3000, punchGain: 1.5 }, // impactful percussion
      other: { volume: 1.05, width: 1.25, deMudFreq: 350, deMudGain: -1.5 }
    }
  },
  acoustic_instrumental: {
    ...
    airTrebleFreq: 9000,
    stemMix: {
      vocals: { volume: 1.30, highpass: 100, trebleGain: 2.0, trebleFreq: 8000 }, // intimate lead vocal
      ...
      other: { volume: 1.15, width: 1.08, deMudFreq: 260, deMudGain: -2.0, bodyFreq: 220, bodyGain: 1.0 } // warm guitars
    }
  },
  meditation_chillout: {
    ...
    airTrebleFreq: 11500,
    stemMix: {
      vocals: { volume: 1.00, highpass: 120, trebleGain: 2.0, trebleFreq: 9000 },
      ...
      other: { volume: 1.10, width: 1.40, deMudFreq: 300, deMudGain: -2.0 } // maximum spherical pads
    }
  },
  streaming_pop_standard: {
    ...
    airTrebleFreq: 10000,
    stemMix: {
      vocals: { volume: 1.35, highpass: 100, trebleGain: 3.0, trebleFreq: 9000 }, // radio upfront
      bass: { volume: 1.05, mono: true, lowpass: 450, boostFreq: 90, boostGain: 1.2 },
      drums: { volume: 1.25, punchFreq: 3500, punchGain: 2.0 }, // punchy kick/snare
      other: { volume: 0.80, width: 1.15, deMudFreq: 400, deMudGain: -2.5 }
    }
  },
  stadium_live_rock: {
    ...
    airTrebleFreq: 11000,
    stemMix: {
      vocals: { volume: 1.25, highpass: 90, trebleGain: 2.5, trebleFreq: 7500 },
      bass: { volume: 1.15, mono: true, lowpass: 500, boostFreq: 70, boostGain: 2.0 },
      drums: { volume: 1.30, punchFreq: 2500, punchGain: 2.5 }, // snappy live snare & kick
      other: { volume: 1.15, width: 1.25, deMudFreq: 300, deMudGain: -1.5, guitarBiteFreq: 2200, guitarBiteGain: 1.5 } // electric guitar bite
    }
  },
  custom: {
    name: 'Custom',
