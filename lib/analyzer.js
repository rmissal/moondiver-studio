...
// Intelligent genre detection based on acoustic DNA and metadata
function detectGenre(filePath, acousticData = {}, metadata = {}) {
  ...
  const keywords = {
    ...
    new_age_ambient: ['ambient', 'new age', 'dream', 'ethereal', 'atmosphere', 'spheric', 'echo', 'lush', 'fantasy', 'chill', 'pad', 'drone', 'aurora', 'space', 'truth', 'hope', 'continuity', 'springs', 'frozen', 'time', 'flow', 'current', 'glow', 'gleam', 'cosmos', 'weightless', 'water'],
    ...
    acoustic_instrumental: ['acoustic', 'guitar', 'piano', 'harp', 'cello', 'violin', 'unplugged', 'folk', 'woodwind', 'flute', 'solo', 'organic', 'nature', 'duet', 'strings'],
